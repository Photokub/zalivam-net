        ...
        <section className='methods'>
            <div className="methods__warp">
                ...
                <div className="methods__textContainer">
                    <p className="methods__paragraph">Наши юристы занимаются вопросами, связанными с заливом квартир и возмещением причиненного ущерба. Работа юристов включает в себя консультации клиентов, оценку размера ущерба, переговоры со страховыми компаниями (если это необходимо), подготовку всех необходимых документов и судебную защиту.</p>
                    <p className="methods__paragraph">Мы не навязываем дополнительных услуг</p>
                    <p className="methods__paragraph">Стоимость услуг обоснована, формируется в зависимости от Ваших запросов и остается неизменной до окончания выполнения договора. Оплата услуг возможна по факту возмещения ответчиком причиненного Вам вреда.</p>
                    <p className="methods__paragraph">Наши специалисты представляют комплекс услуг в случае залива помещения. Мы создали все условия для комфортного взаимодействия и работы с клиентами и помогаем получить возмещение убытков, в проведении экспертизы и оценки.</p>
